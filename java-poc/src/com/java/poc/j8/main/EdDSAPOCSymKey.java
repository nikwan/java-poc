...
public class EdDSAPOCSymKey {
	...
	public static void main(String[] args) {
		...
		try {
	        ...
	        System.out.println("hex_pr_k:" + new String (Hex.encode(privateKey1.getEncoded())));
	        System.out.println("hex_pub_k:" + new String (Hex.encode(publicKey1.getEncoded())));
			
			Ed25519PrivateKeyParameters privateKey = new Ed25519PrivateKeyParameters(
		            Hex.decode("eea3dcd6550740f41278641a344804e3e59f74b12ab19d67f57edf2e33c3616c"), 0);
		        Ed25519PublicKeyParameters publicKey = new Ed25519PublicKeyParameters(
		            Hex.decode("7bcdd2676ec1f08c3da1f6bc41f7edc4e40666f4010f07c355ab698be51df8ad"), 0);
